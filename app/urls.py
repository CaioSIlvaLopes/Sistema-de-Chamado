...
from users.views import register, dashboard_technical, ticket_action, verify_email, registration_pending
...
urlpatterns = [
    ...
    path("Cadastro/pendente/", registration_pending, name="registration_pending"),
    path('users/verify/', verify_email, name='verify_email'),
